...
public class ModVariableOperation implements Operation {
    ...
    private ModVariableOperation(final BasicVirtualMachineImpl vm, final String variableName) {
        this.vm = vm;
        this.variableName = variableName;
        this.index = 0;
    }
